const cards = [
  ...
  { key: 'webhookFalhou', label: 'Webhook falhou', accent: 'bg-amber-100 text-amber-700' },
  { key: 'pendentesRevisao', label: 'Pendentes de revisão', accent: 'bg-sky-100 text-sky-700' }
];
